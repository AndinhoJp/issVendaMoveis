 ...
 * @author ander
 */
public class JFrameTelaLoginDesconto extends javax.swing.JFrame {

    /**
     * Creates new form TelaLogin
     */
    public  JFrameTelaLoginDesconto() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameTelaLoginDesconto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameTelaLoginDesconto().setVisible(true);
            }
        });
    }

    boolean autenticar() {
        boolean login = new ControleLogin().verificaAcessoDesconto(jTextFieldLogin.getText(), jPassword.getText());
        if (login) {
            dispose();
            return true;
        } 
