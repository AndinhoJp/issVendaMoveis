...
public class Produto  implements java.io.Serializable {
    ...
    public Produto(String prodId, String nomeProd, int quantidadeEstoque, String descricao, Float precoVenda, Float precoCusto, Float altura, Float largura, Float profundidade, String marca, Set prodVendas, Set prodPedEstoques, Set imagemProdutos) {
       this.prodId = prodId;
       this.nomeProd = nomeProd;
       this.quantidadeEstoque = quantidadeEstoque;
