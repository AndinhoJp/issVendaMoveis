...
CREATE TABLE `Faltas` (
  `idFaltas` varchar(60) NOT NULL,
  `id_func` varchar(60) DEFAULT NULL,
  `justificativaFlag` int(1) DEFAULT NULL,
  `justificativatextual` varchar(60) DEFAULT NULL,
  `datafalta` date DEFAULT NULL,
  PRIMARY KEY (`idFaltas`),
  KEY `Funcionario_idx` (`id_func`),
  CONSTRAINT `Funcionario` FOREIGN KEY (`id_func`) REFERENCES `Funcionario` (`id_func`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2017-10-23 20:01:58
